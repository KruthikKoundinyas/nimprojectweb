$(document).ready(function () {
  ...
  function initializeQ(states, actions) {
    let Q = {};
    states.forEach((state) => {
      Q[state] = {};
      actions.forEach((action) => {
        Q[state][action] = 0; // Initialize with zero
      });
    });
    return Q;
  }

  // Call this function to initialize Q
  Q = initializeQ(states, actions);
...
// Load Q-values from JSON file
$.getJSON("q_values.json", function (data) {
  Q = data; // Assuming Q is already defined globally
